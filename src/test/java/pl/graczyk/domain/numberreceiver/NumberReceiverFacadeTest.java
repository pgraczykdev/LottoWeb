...
public class NumberReceiverFacadeTest {
    ...
    private final TicketRepository ticketRepository = new InMemoryTicketRepositoryTestImplementation();
    Clock clock = Clock.systemUTC();

    @Test
    public void should_return_correct_response_when_user_input_six_numbers_in_range() {
        // given
        HashGenerable hashGenerator = new HashGeneratorTestImplementation();
        ...
        TicketDto generatedTicket = new TicketDto(hashGenerator.getHash(), nextDrawDate, numbersFromUser);
